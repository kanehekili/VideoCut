...
def testFrameProbe():
    ...
    #m=FFStreamProbe("/home/matze/Videos/Kids-RWSM/00006.MTS")
    #ERROR ! m=FFStreamProbe("/home/matze/Videos/VCR/tnt-uhf22-482MHz-2019-01-22.ts")#multiple videos!
    m=FFStreamProbe("/media/disk1/UHD/Volcano_Lava_Sample.webm")
    ...
    for s in m.streams:
        ...
        print ("frameRateMultiple: ", s.frameRateMultiple())
        print ("frameRateAvg: ", s.frameRateAvg())
        print ("saneFPS: ", s.saneFPS())
        print ("isInterlaced: ", s.isInterlaced())
